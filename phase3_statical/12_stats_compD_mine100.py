# -*- coding: utf-8 -*-
"""
Script 12 — Testes estatísticos | Comparação D: DREAM vs. MINE (SizeL=100)
==========================================================================
...
Uso
---
python 10_stats_compD_mine100.py
python 10_stats_compD_mine100.py --wilcoxon --latex
"""
...
DESCRIPTION   = "Comparação D — DREAM vs. MINE SizeL=1000 (30 datasets, MSE)"
SIZEL         = 100
