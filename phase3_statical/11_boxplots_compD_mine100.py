# -*- coding: utf-8 -*-
"""
Script 11 — Boxplots | Comparação D: DREAM vs. MINE (SizeL=100)
===============================================================
Métodos DREAM : DREAM-DS, DREAM-DW, DREAM-DWS
Métodos MINE  : MINE-DS, MINE-DW, MINE-DWS  (ensemble homogêneo, SizeL=100)
Datasets      : 30
...
Uso
---
python 09_boxplots_compD_mine100.py
python 09_boxplots_compD_mine100.py --dpi 150 --output-dir outputs/compD10_boxplots
"""
...
LABEL       = "dream_x_mine100"
DESCRIPTION = "Comparação D — DREAM vs. MINE SizeL=1000 (30 datasets, métrica: MSE)"
SIZEL       = 100
